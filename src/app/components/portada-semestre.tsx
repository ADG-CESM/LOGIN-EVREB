...
interface PortadaSemestreProps {
    titulo: string;
    hrefTablero: string;
    cta: string;
}

export default function PortadaSemestre({
    titulo,
    hrefTablero,
    cta,
}: PortadaSemestreProps) {
    return (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
                    <div>
                        <span className="inline-flex items-center rounded-full bg-indigo-100/70 px-3 py-1 text-xs font-medium text-[#193d77] ring-1 ring-inset ring-indigo-200">
                            Navegacion de Recursos Educativos
                        </span>
                        <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl">
                            {titulo}
                        </h1>
                        <p className="mt-4 text-base leading-7 text-[#193d77] sm:text-lg"></p>
